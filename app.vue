<template>
  <div>
    <div>
      <div class="mx-auto mt-40 card h-96 w-96 bg-white text-black">
        <div class="card-body">
          <div class="avatar mx-auto">
            <div class="w-24 rounded-full">
              <img
                src="https://cdn.discordapp.com/avatars/785248634458996767/f14a15f7db919d6420b6498fb396085f.png?size=2048"
              />
            </div>
          </div>
